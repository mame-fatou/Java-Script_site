...
<p> Choisissez la ville qui vous intéresse afin de voir toutes les gares qui s'y trouvent et d'obtenir des informations !</p></br>   
...
$rep = $bdd->query('select * from ville where region = "Ile de France"');
