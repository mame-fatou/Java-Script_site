...
$rep = $bdd->query('select POURCENTAGE from FREQUENTATION where NOM_GARE="Bordeaux Saint-Jean" and ANNEE=2014 order by POURCENTAGE') ;
...
$graph->title->Set('Bordeaux Saint-Jean');
$graph->title->SetMargin(10);
 
//$graph->subtitle->SetFont(FF_ARIAL, FS_BOLD, 10);
$graph->subtitle->Set('2014');
