...
$rep = $bdd->query('select POURCENTAGE from FREQUENTATION where NOM_GARE="Aéroport Charles de Gaulle 2 TGV" and ANNEE=2013 order by POURCENTAGE') ;
...
$graph->title->Set('Aéroport Charles de Gaulle 2 TGV');
